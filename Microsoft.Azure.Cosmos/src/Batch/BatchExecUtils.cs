...
namespace Microsoft.Azure.Cosmos
{
    ...
    {
        /// <summary>
        /// https://msdata.visualstudio.com/CosmosDB/_workitems/edit/377978 to get this via Constants in Cosmos.Direct.
        /// </summary>
        public const int StatusCodeFailedDependency = 424;
        public const int StatusCodeMultiStatus = 207;
...
#pragma warning restore VSTHRD103 // Call async methods when in an async method
        ...
        {
            maxServerRequestBodyLength = BatchConstants.MaxDirectModeBatchRequestBodySizeInBytes;
            maxServerRequestOperationCount = BatchExecUtils.MaxOperationsInDirectModeBatchRequest;
        }
