...
namespace Microsoft.Azure.Cosmos.SDK.EmulatorTests
{
    ...
    using Microsoft.Azure.Cosmos.Friends;
    ...
    public class BatchSinglePartitionKeyTests : CosmosBatchTestBase
    {
        ...
        public async Task BatchItemETagAsync()
        {
...

            {
                ...
                BatchSinglePartitionKeyTests.VerifyBatchProcessed(
                    ...
                    expectedStatusCode: (HttpStatusCode)BatchExecUtils.StatusCodeMultiStatus);
        ...
        public async Task BatchLargerThanServerRequestAsync()
        {
            ...
            int appxDocSize = BatchConstants.MaxDirectModeBatchRequestBodySizeInBytes / operationCount;
        ...
        public async Task BatchWithTooManyOperationsAsync()
        {
            ...
            const int operationCount = BatchExecUtils.MaxOperationsInDirectModeBatchRequest + 1;
        ...
        public async Task BatchServerResponseTooLargeAsync()
        {
            ...
            Assert.AreEqual((int)BatchExecUtils.StatusCodeFailedDependency, (int)batchResponse[0].StatusCode);
        ...
        public async Task BatchRateLimitingAsync()
        {
            ...
            CosmosClient clientWithNoThrottleRetry = new CosmosClientBuilder(
                    ...
                    CosmosBatchTestBase.Client.ClientOptions.AccountKey.ToString())
        ...
        private async Task<CosmosBatchResponse[]> RunTwoLargeBatchesAsync(CosmosContainer container)
        {
            ...
            for (int i = 0; i < BatchExecUtils.MaxOperationsInDirectModeBatchRequest; i++)
            {
        ...
        { 
            ...
            Assert.AreEqual((HttpStatusCode)BatchExecUtils.StatusCodeFailedDependency, batchResponse[0].StatusCode);
            Assert.AreEqual(expectedFailedOperationStatusCode, batchResponse[1].StatusCode);
            Assert.AreEqual((HttpStatusCode)BatchExecUtils.StatusCodeFailedDependency, batchResponse[2].StatusCode);
