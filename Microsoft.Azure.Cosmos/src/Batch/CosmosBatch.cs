...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class CosmosBatch
    {
        ...
        /// <param name="cancellationToken">(Optional) <see cref="CancellationToken"/> representing request cancellation.</param>
        /// <returns>An awaitable <see cref="CosmosBatchResponse"/> which contains the completion status and results of each operation.</returns>
        protected internal virtual Task<CosmosBatchResponse> ExecuteAsync(RequestOptions requestOptions, CancellationToken cancellationToken = default(CancellationToken))
        {
